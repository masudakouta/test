...
#define TEXTURE_FILENAME		"data/MODEL/zombieee.png"
//*****************************************************************************
// プロトタイプ宣言
//*****************************************************************************
...
// 初期化処理
//=============================================================================
HRESULT InitItem(int stage)
{
	LPDIRECT3DDEVICE9 pDevice = GetDevice();
	ITEM *item = g_aItem;				// エネミーのポインターを初期化
	...
	item = g_aItem;
	for(int nCntItem = 0; nCntItem < stage+1; nCntItem++,item)
	{
...

{
	for (int nCntItem = 0; nCntItem < MAX_ITEM; nCntItem++)
	{
		if (g_aItem[nCntItem].bUse)
		{
			...
			g_aItem[nCntItem].pos.y = Get(g_aItem[nCntItem].pos);
	}
}
